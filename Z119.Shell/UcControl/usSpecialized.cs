...
{
    public partial class usSpecialized : UserControl
    {
        public SpecializedManager manager = new SpecializedManager();
        int? TotalPage = 0;
        int? PageIndex = 1;
        int? PageSize = 20;
        string Searching = "";

        public usSpecialized()
        {
            InitializeComponent();
        ...
        public List<SpecializedBindingModel> GetList(string name, int? pageIndex, int? pageSize)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!add)
            {
                SpecializedBindingModel model = new SpecializedBindingModel()
                {
                    Name = txtName.Text
                };
