...
{
    public partial class ucSpecialCategory : UserControl
    {
        SpecialCategoryManager manager = new SpecialCategoryManager();
        int? TotalPage = 0;
        int? PageIndex = 1;
        int? PageSize = 20;
        string Searching = "";
        ...
        public List<SpecialCategoryBindingModel> GetList(string name, int? pageIndex, int? pageSize)
        {
        ...
        public void BindingData()
        {
            ...
            Binding bdDescription = new Binding("Text", dgvData.DataSource, "Description", true, DataSourceUpdateMode.Never);
            txtDescription.DataBindings.Clear();
            txtDescription.DataBindings.Add(bdDescription);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!add)
            {
                SpecialCategoryBindingModel model = new SpecialCategoryBindingModel()
                {
                    Name = txtName.Text,
