...
{
    public partial class ucBookShelf : UserControl
    {
        public BookShelfManager manager = new BookShelfManager();
        int? TotalPage = 0;
        int? PageIndex = 1;
        int? PageSize = 20;
        string Searching = "";
        ...
        public List<BookShelfBindingModel> GetList(string name, int? pageIndex, int? pageSize)
        {
